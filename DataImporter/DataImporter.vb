...
#Region "properties"
    ...
    Public Property binFolderLocation As String = Nothing
            ...
            Try
                If Not assmHT.ContainsKey(filename) Then
                    If filename.EndsWith(".vb") Then
                        ...
                        If Not String.IsNullOrWhiteSpace(binFolderLocation) Then
                            folder = binFolderLocation & "\"
                        End If
...
#Region "Parse File"
    ...
    Public Function UploadTable(inputTable As DataTable, Optional tableName As String = "", Optional deleteExisting As Boolean = False, Optional uniqueIdentifierColumns As String = Nothing, Optional columnNames As String = Nothing, Optional createIfMissing As Boolean = True) As Boolean
        Try
            If tableName = "" Then tableName = inputTable.TableName
    ...
    Private Function UploadTable(tableName As String, Optional deleteExisting As Boolean = False, Optional uniqueIdentifierColumns As String = Nothing, Optional columnNames As String = Nothing, Optional createIfMissing As Boolean = True, Optional inputTable As DataTable = Nothing) As Boolean
        ...
        ElseIf fileFormat = Format.json Then
            ...
            max = jsonList.Count
        ElseIf fileFormat = Format.excel Or fileFormat = Format.odbc Then
        ...
        Else
            ...
            End If
            If fileFormat = Format.odbc Then
                Dim colList As New List(Of String)
                For Each col As DataColumn In inputTable.Columns
            ...
            End If
        End If
        If fileFormat = Format.odbc Then fileFormat = Format.excel  'Set it to excel for the rest of the import
        If fileFormat = Format.excel Then
            ...
            If errorDetailsCt < 10 Then
                For Each col As DataColumn In dt.Columns
                    ...
                    ElseIf typename = "Boolean" Then
                        typename = "bit"
                        If val = True Then val = "1" Else val = "0"
                    End If
    ...
    Public Function parseRowVal(row As DataRow, colname As String, value As Object) As Object
        ...
        End If
        Return parseTypeVal(row.Table.Columns(colname).DataType, value, colname)
    End Function

    Public Function parseTypeVal(t As Type, value As Object, Optional columnName As String = "", Optional throwError As Boolean = False) As Object
        ...
        Catch ex As Exception
            If (throwError) Then Throw ex
            Dim message = ""
            If columnName <> "" Then
                message = "Error parsing column: " & columnName
            End If
            logerror(ex, message)
            Return DBNull.Value
        End Try
